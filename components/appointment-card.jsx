...
export function AppointmentCard({
  ...
  return (
    <>
      <Card className="border-fuchsia-900/20 hover:border-fuchsia-700/30 transition-all">
              ...
              <Badge
                ...
                className={
                  appointment.status === "COMPLETED"
                    ? "bg-fuchsia-900/20 border-fuchsia-900/30 text-fuchsia-400"
          ...
          <div className="space-y-4 py-4">
            ...
            <div className="space-y-2">
              ...
              <div className="flex items-center">
                <div className="h-5 w-5 text-fuchsia-400 mr-2">
                  {otherPartyIcon}
                </div>
                <div>
            ...
            <div className="space-y-2">
              ...
              <div className="flex flex-col gap-1">
                ...
                <div className="flex items-center">
                  <Clock className="h-5 w-5 text-fuchsia-400 mr-2" />
                  <p className="text-white">
                    {formatTime(appointment.startTime)} -{" "}
                    {formatTime(appointment.endTime)}
                  </p>
            ...
            {appointment.patientDescription && (
              <div className="space-y-2">
                ...
                <div className="p-3 rounded-md bg-muted/20 border border-fuchsia-900/20">
                ...
                {userRole === "DOCTOR" &&
                  ...
                  appointment.status !== "CANCELLED" && (
                    <Button
                      ...
                      className="h-7 text-fuchsia-400 hover:text-fuchsia-300 hover:bg-fuchsia-900/20"
                    >
              ...
              {userRole === "DOCTOR" && action === "notes" ? (
                <div className="space-y-3">
                  <Textarea
                    ...
                    className="bg-background border-fuchsia-900/20 min-h-[100px]"
                  />
                ...
                <div className="p-3 rounded-md bg-muted/20 border border-fuchsia-900/20 min-h-[80px]">
                  {appointment.notes ? (
                    <p className="text-white whitespace-pre-line">
                      {appointment.notes}
                    </p>
