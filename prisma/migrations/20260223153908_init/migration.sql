...
-- CreateTable
CREATE TABLE "public"."WearableToken" (
    "id" TEXT NOT NULL,
    "userId" TEXT NOT NULL,
    ...
    CONSTRAINT "WearableToken_pkey" PRIMARY KEY ("id")
);
...
-- CreateIndex
CREATE UNIQUE INDEX "WearableToken_userId_provider_key" ON "public"."WearableToken"("userId", "provider");

-- CreateIndex
CREATE UNIQUE INDEX "HealthAssessment_userId_period_dateKey_key" ON "public"."HealthAssessment"("userId", "period", "dateKey");
...
-- AddForeignKey
ALTER TABLE "public"."WearableToken" ADD CONSTRAINT "WearableToken_userId_fkey" FOREIGN KEY ("userId") REFERENCES "public"."User"("id") ON DELETE CASCADE ON UPDATE CASCADE;
