          ...
          <Card className="border-fuchsia-900/20">
            <CardContent className="pt-6">
              <div className="flex flex-col items-center text-center">
                <div className="relative w-32 h-32 rounded-full overflow-hidden mb-4 bg-fuchsia-900/20">
                  {doctor.imageUrl ? (
                    <Image
                      src={doctor.imageUrl}
                      alt={doctor.name}
                    ...
                    <div className="w-full h-full flex items-center justify-center">
                      <User className="h-16 w-16 text-fuchsia-400" />
                    </div>
                  )}
                </div>
                ...
                <Badge
                  variant="outline"
                  className="bg-fuchsia-900/20 border-fuchsia-900/30 text-fuchsia-400 mb-4"
                >
                  {doctor.specialty}
                </Badge>
