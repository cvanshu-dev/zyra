  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        <Card className="border-fuchsia-900/20">
          <CardContent className="p-6">
            <div className="flex items-center justify-between">
              ...
              <div className="bg-fuchsia-900/20 p-3 rounded-full">
                <Coins className="h-6 w-6 text-fuchsia-400" />
              </div>
            </div>
          </CardContent>
        </Card>
      ...
      <Card className="border-fuchsia-900/20">
        <CardHeader>
          <CardTitle className="text-xl font-bold text-white flex items-center">
            <CreditCard className="h-5 w-5 mr-2 text-fuchsia-400" />
            Payout Management
          </CardTitle>
        </CardHeader>
          ...
          <div className="bg-muted/20 p-4 rounded-lg border border-fuchsia-900/20">
            <div className="flex items-center justify-between mb-3">
              ...
              {pendingPayout ? (
                ...
                <Badge
                  variant="outline"
                  className="bg-fuchsia-900/20 border-fuchsia-900/30 text-fuchsia-400"
                >
                  Available
                </Badge>
              )}
            ...
            <div className="space-y-2">
              ...
              <div className="space-y-2">
                {payouts.slice(0, 5).map((payout) => (
                  <div
                    key={payout.id}
                    className="flex items-center justify-between p-3 rounded-md bg-muted/10 border border-fuchsia-900/10"
                  >
                    <div>
                      <p className="text-white font-medium">
        ...
        <DialogContent>
          ...
          <form onSubmit={handlePayoutRequest} className="space-y-4">
            <div className="bg-muted/20 p-4 rounded-lg space-y-2">
              ...
              <div className="border-t border-fuchsia-900/20 pt-2 flex justify-between font-medium">
