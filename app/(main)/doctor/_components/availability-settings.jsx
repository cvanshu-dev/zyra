    ...
    <Card className="border-fuchsia-900/20">
      <CardHeader>
        <CardTitle className="text-xl font-bold text-white flex items-center">
          <Clock className="h-5 w-5 mr-2 text-fuchsia-400" />
      ...
      <CardContent>
        ...
        {!showForm ? (
              ...
              {slots.length === 0 ? (
                ...
                <div className="space-y-3">
                  {slots.map((slot) => (
                    <div
                      key={slot.id}
                      className="flex items-center p-3 rounded-md bg-muted/20 border border-fuchsia-900/20"
                    >
          ...
          <form
            ...
            className="space-y-4 border border-fuchsia-900/20 rounded-md p-4"
          >
        ...
        <div className="mt-6 p-4 bg-muted/10 border border-fuchsia-900/10 rounded-md">
