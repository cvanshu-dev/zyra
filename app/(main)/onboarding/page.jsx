  ...
  if (step === "choose-role") {
    return (
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <Card
          className="border-fuchsia-900/20 hover:border-fuchsia-700/40 cursor-pointer transition-all"
          onClick={() => !loading && handlePatientSelection()}
        >
          <CardContent className="pt-6 pb-6 flex flex-col items-center text-center">
            <div className="p-4 bg-fuchsia-900/20 rounded-full mb-4">
        ...
        >
          <CardContent className="pt-6 pb-6 flex flex-col items-center text-center">
            <div className="p-4 bg-fuchsia-900/20 rounded-full mb-4">
              <Stethoscope className="h-8 w-8 text-fuchsia-400" />
            </div>
            <CardTitle className="text-xl font-semibold text-white mb-2">
              Join as a Doctor
            </CardTitle>
              ...
              >
                ...
                <SelectContent>
                  {SPECIALTIES.map((spec) => (
                    ...
                    >
                      <span className="text-fuchsia-400">{spec.icon}</span>
                      {spec.name}
                    </SelectItem>
                  ))}
                </SelectContent>
