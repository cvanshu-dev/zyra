...
export function PendingPayouts({ payouts }) {
  ...
  return (
    <div>
      <Card className="bg-muted/20 border-fuchsia-900/20">
        <CardHeader>
          ...
          {payouts.length === 0 ? (
            ...
            <div className="space-y-4">
              {payouts.map((payout) => (
                <Card
                  key={payout.id}
                  className="bg-background border-fuchsia-900/20 hover:border-fuchsia-700/30 transition-all"
                >
                      ...
                      <div className="flex items-start gap-3">
                        ...
                        <div className="flex-1">
                          ...
                          <div className="flex flex-wrap items-center gap-4 mt-2 text-sm text- ">
                            ...
                            <div className="flex items-center">
                              <Mail className="h-4 w-4 mr-1 text-fuchsia-400" />
                      ...
                      <div className="flex flex-col sm:flex-row gap-2 self-end lg:self-center">
                        ...
                        <div className="flex gap-2">
                          <Button
                            ...
                            className="border-fuchsia-900/30 hover:bg-muted/80"
                          >
                            View Details
                          </Button>
                          <Button
            ...
            <div className="space-y-6 py-4">
              ...
              <div className="space-y-4">
                ...
                <div className="bg-muted/20 p-4 rounded-lg border border-fuchsia-900/20 space-y-3">
                  ...
                  <div className="border-t border-fuchsia-900/20 pt-3 flex justify-between font-medium">
