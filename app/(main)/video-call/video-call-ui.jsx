      ...
      <div className="container mx-auto px-4 py-8">
        ...
        {isLoading && !scriptLoaded ? (
          <div className="flex flex-col items-center justify-center py-12">
            <Loader2 className="h-12 w-12 text-fuchsia-400 animate-spin mb-4" />
          ...
          <div className="space-y-6">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div className="border border-fuchsia-900/20 rounded-lg overflow-hidden">
                <div className="bg-fuchsia-900/10 px-3 py-2 text-fuchsia-400 text-sm font-medium">
                  You
                </div>
                <div
                  id="publisher"
                  ...
                  {!scriptLoaded && (
                    <div className="flex items-center justify-center h-full">
                      <div className="bg-muted/20 rounded-full p-8">
                        <User className="h-12 w-12 text-fuchsia-400" />
                      </div>
                    </div>
                  )}
                </div>
