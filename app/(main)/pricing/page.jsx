  ...
  return (
    <div className="container mx-auto px-4 py-12">
      ...
      <div className="flex justify-start mb-2">
        <Link
          href="/"
          className="flex items-center text-  hover:text-white transition-colors"
        >
      ...
      <div className="max-w-full mx-auto mb-12 text-center">
        ...
        <p className="text-lg text-  max-w-2xl mx-auto">
      ...
      <div className="max-w-3xl mx-auto mt-16 text-center">
        ...
        <p className="text-  mb-4">
          Contact our support team at support@Carenex.com
        </p>
      </div>
    </div>
  );
